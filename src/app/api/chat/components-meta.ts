...
export const componentsMeta: ComponentMeta[] = [
  ...
  },
  {
    ...
    propsSchema: {
      ...
      titleProps: "React.ComponentProps<typeof AlertTitle>（透传给标题节点）",
      descriptionProps: "React.ComponentProps<typeof AlertDescription>（透传给描述节点）",
    },
    dslExample: {
      type: "Alert4u",
      props: {
  ...
  },
  {
    ...
    propsSchema: {
      ...
      triggerProps: "Omit<AlertDialogTrigger props, 'children'>（触发器参数透传）",
      contentProps: "Omit<AlertDialogContent props, 'children'>（内容容器参数透传）",
      headerProps: "React.ComponentProps<typeof AlertDialogHeader>（头部容器透传）",
      mediaProps: "React.ComponentProps<typeof AlertDialogMedia>（媒体区透传）",
      titleProps: "React.ComponentProps<typeof AlertDialogTitle>（标题透传）",
      descriptionProps: "React.ComponentProps<typeof AlertDialogDescription>（描述透传）",
      footerProps: "React.ComponentProps<typeof AlertDialogFooter>（底部容器透传）",
      cancelProps: "Omit<AlertDialogCancel props, 'children'>（取消按钮透传）",
      actionProps: "Omit<AlertDialogAction props, 'children'>（确认按钮透传）",
    },
    dslExample: {
      type: "AlertDialog4u",
      props: {
  ...
  },
  {
    ...
    propsSchema: {
      ...
      classNames: "DayPicker['classNames']（日期单元等子节点 className 映射）",
      showOutsideDays: "boolean（是否展示相邻月份日期）",
      captionLayout: "DayPicker captionLayout（月份标题区域布局）",
      buttonVariant: "Button variant（日历导航按钮样式）",
      formatters: "DayPicker['formatters']（日期文本格式化）",
      components: "DayPicker['components']（自定义子组件渲染）",
    },
    dslExample: {
      type: "CalendarSingle",
      props: {
  ...
  },
  {
    ...
    propsSchema: {
      ...
      headerAction: "ReactNode（头部右上角操作区内容）",
      content: "ReactNode（卡片主体内容）",
      footer: "ReactNode（自定义底部内容）",
      actionLabel: "ReactNode（默认底部按钮文案）",
      ...
      headerProps: "React.ComponentProps<typeof CardHeader>（头部容器透传）",
      actionProps: "React.ComponentProps<typeof CardAction>（头部操作区透传）",
      titleProps: "React.ComponentProps<typeof CardTitle>（标题透传）",
      descriptionProps: "React.ComponentProps<typeof CardDescription>（描述透传）",
      contentProps: "React.ComponentProps<typeof CardContent>（主体透传）",
      footerProps: "React.ComponentProps<typeof CardFooter>（底部透传）",
      buttonProps: "React.ComponentProps<typeof Button>（默认底部按钮透传）",
    },
    dslExample: {
      type: "Card4u",
      props: {
  ...
  },
  {
    ...
    propsSchema: {
      ...
      previousProps: "React.ComponentProps<typeof CarouselPrevious>（透传上一页按钮参数）",
      nextProps: "React.ComponentProps<typeof CarouselNext>（透传下一页按钮参数）",
    },
    dslExample: {
      type: "Carousel4u",
      props: {
  ...
  },
  {
    ...
    propsSchema: {
      ...
      containerProps: "ChartContainer props（透传图表容器参数）",
      composedChartProps: "ComposedChart props（透传 Recharts 组合图参数）",
    },
    dslExample: {
      type: "Chart4u",
      props: {
  ...
  },
  {
    ...
    propsSchema: {
      ...
      legendProps: "React.ComponentProps<typeof FieldLegend>（透传给图例标题）",
      legendDescriptionProps: "React.ComponentProps<typeof FieldDescription>（透传给图例描述）",
      items: "{ id?: string; orientation?: 'horizontal' | 'vertical'; content: ReactNode; description?: ReactNode; className?: string; contentClassName?: string; labelClassName?: string; descriptionClassName?: string; checked?: boolean | 'indeterminate'; defaultChecked?: boolean; onCheckedChange?: (checked) => void; disabled?: boolean; fieldProps?: Field props; contentProps?: FieldContent props; labelProps?: FieldLabel props; descriptionProps?: FieldDescription props; checkboxProps?: Checkbox props(去除受控字段) }[]（复选项数组）",
    },
    dslExample: {
      type: "Checkbox4u",
      props: {
  ...
  },
  {
    ...
    propsSchema: {
      ...
      className: "string（FieldSet 根容器 Tailwind CSS 类名）",
      legendProps: "React.ComponentProps<typeof FieldLegend>（透传图例参数）",
  ...
  },
  {
    ...
    propsSchema: {
      ...
      leftSeparatorProps: "React.ComponentProps<typeof Separator>（双分割线模式左侧参数）",
      rightSeparatorProps: "React.ComponentProps<typeof Separator>（双分割线模式右侧参数）",
    },
    dslExample: {
      type: "Separator4u",
      props: {
